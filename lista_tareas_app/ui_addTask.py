...
class Ui_AddTaskWindow(object):
    def setupUi(self, AddTaskWindow):
        ...
        self.verticalLayout_2.addWidget(self.agregar_tarea_text)
        ...
        self.fecha_input.setDateTime(QDateTime(QDate(2024, 1, 1), QTime(0, 0, 0)))
        ...
        self.boton_agregar_tarea = QPushButton(self.frame_5)
        self.boton_agregar_tarea.setObjectName(u"boton_agregar_tarea")
        self.boton_agregar_tarea.setMinimumSize(QSize(150, 35))
        font2 = QFont()
        font2.setPointSize(10)
        font2.setBold(True)
        self.boton_agregar_tarea.setFont(font2)

        self.verticalLayout_6.addWidget(self.boton_agregar_tarea)
    ...
    def retranslateUi(self, AddTaskWindow):
        ...
        self.agregar_tarea_text.setText(QCoreApplication.translate("AddTaskWindow", u"Agregar tarea nueva", None))
        self.titulo_text.setText(QCoreApplication.translate("AddTaskWindow", u"T\u00edtulo", None))
        self.titulo_tarea_input.setPlaceholderText(QCoreApplication.translate("AddTaskWindow", u"Ingresa el t\u00edtulo de la nueva tarea", None))
        self.descripcion_text.setText(QCoreApplication.translate("AddTaskWindow", u"Descripci\u00f3n", None))
        self.desc_tarea_input.setPlaceholderText(QCoreApplication.translate("AddTaskWindow", u"Ingresa la descripci\u00f3n", None))
        self.fecha_text.setText(QCoreApplication.translate("AddTaskWindow", u"Fecha l\u00edmite", None))
        self.boton_agregar_tarea.setText(QCoreApplication.translate("AddTaskWindow", u"Agregar tarea", None))
        self.alerta.setText("")
        self.cancel_button.setText(QCoreApplication.translate("AddTaskWindow", u"Cancelar", None))
    # retranslateUi
